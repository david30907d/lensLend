...
contract Lending {
    ...
    MockBob public mockBobContract;
    ...
    constructor(address _bobTokenAddress, address _zkBobDirectDepositAddress, address _mockBobAddress) {
    ...
    function createLoan(uint256 _amount, uint256 _interestRate, bytes memory zkAddress) external {
        ...
        // need to approve BobToken for this contract
        bobToken.approve(address(bobDirectDepositContract), _amount);
        console.log("current allowance", bobToken.allowance(address(this), address(bobDirectDepositContract)), _amount);
        console.log("real user", msg.sender);
        console.log("contract address", address(this));
        mockBobContract.showMsgSender();
        // bobDirectDepositContract.directDeposit(msg.sender, _amount, zkAddress);
        // loans[msg.sender] = newLoan;
        // console.log("Loan created");
        // console.log(msg.sender);
        // console.log(loans[msg.sender].amount);
        // console.log("==============");
        // console.log("==============");
        // console.log("==============");
